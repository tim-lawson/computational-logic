...
\end{arguments}
    ...
    \predicate[private]{prove_from_known_facts}{5}{+Clause:atom, +TruthValue:atom, +FactList:list, -ProofList:list, -Proof:atom}
...
\end{arguments}
    ...
    \predicate[private]{prove_from_known_facts}{3}{+Clause:atom, +TruthValue:atom, +FactList:list}
