...
The \predref{prove_from_known_facts}{2} predicate is an entry point to the \predref{prove_from_known_facts}{4}
...
\end{arguments}
    ...
    \predicate[private]{find_known_facts}{1}{-Output:str}
...
\end{arguments}
    ...
    \predicate[private]{find_known_facts_noun}{2}{+ProperNoun:atom, -Output:str}
...
\arg{\Squest} & \arg{Body} The relation between a proposition X and the body of the rule. \\
\arg{\Squest} & \arg{Head} The relation between a proposition X and the head of the rule. \\
