...
The \predref{handle_input}{2} predicate is the main entry point for handling user input. It
...
The \predref{handle_sentence}{2} predicate handles a sentence input. It checks if the fact is
...
The \predref{handle_question}{2} predicate handles a question input. It tries to prove the
...
The \predref{prove_question}{2} predicate tries to prove a question based on the known facts.
...
The \predref{prove_question_list}{2} predicate is like \predref{prove_question}{2}, except it generates the
empty string when the question cannot be proved. This is convenient to use with
maplist, e.g. in \predref{find_all_results}{2}.
