...
\end{arguments}
    ...
    \predicate[private]{prove_from_known_facts}{5}{+Clause:atom, +FactList:list, -ProofList:list, -Proof:atom, -Truth:atom}
The \predref{prove_from_known_facts}{5} predicate tries to prove a clause based on a list of facts.
...
\arg{\Sminus} & \arg{Truth}: The truth-value of the clause.
  \\
\end{arguments}
...
\end{arguments}
    ...
    \dcg[private]{verb_phrase}{3}{?Number:atom, ?Truth:atom, ?Word:atom}
The \dcgref{verb_phrase}{2} DCG rule defines verb phrases. It relates the verb phrase's
grammatical number, its atom, and a list of atoms that refer to it.

\begin{arguments}
\arg{Number} & The grammatical number. \\
\arg{Truth} & The truth-value of the verb phrase. \\
...
\end{arguments}
    ...
    \dcg[private]{determiner}{5}{?Number:atom, ?Truth:atom, ?Body:callable, ?Head:callable, ?Rule:callable}
...
\arg{Truth} & The truth-value of the determiner. \\
