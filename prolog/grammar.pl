...
% e.g. negation(human(X), flies(X)).
determiner(singular, false, X => Body, X => Head, [(negation(Head, Body))]) --> [every].
determiner(plural, false, X => Body, X => Head, [(negation(Head, Body))]) --> [all].
...
determiner(plural, false, X => Body, X => Head, [default((negation(Head, Body)))]) --> [most].
determiner(plural, false, X => Body, X => Head, [default((negation(Head, Body)))]) --> [many].
determiner(plural, false, X => Body, X => Head, [default((negation(Head, Body)))]) --> [a, lot, of].
