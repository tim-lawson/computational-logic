...
determiner(singular, false, X => Body, X => Head, [(dif(Head, Body))]) --> [every].
determiner(plural, false, X => Body, X => Head, [(dif(Head, Body))]) --> [all].
...
determiner(plural, false, X => Body, X => Head, [(dif(Head, Body))]) --> [most].
determiner(plural, false, X => Body, X => Head, [(dif(Head, Body))]) --> [many].
determiner(plural, false, X => Body, X => Head, [(dif(Head, Body))]) --> [a, lot, of].
