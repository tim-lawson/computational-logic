...
determiner(singular, false, X => Body, X => Head, [(disj(Head, Body))]) --> [every].
determiner(plural, false, X => Body, X => Head, [(disj(Head, Body))]) --> [all].
...
determiner(plural, false, X => Body, X => Head, [(disj(Head, Body))]) --> [most].
determiner(plural, false, X => Body, X => Head, [(disj(Head, Body))]) --> [many].
determiner(plural, false, X => Body, X => Head, [(disj(Head, Body))]) --> [a, lot, of].
